                ...
                <div className='flex items-center gap-3'>
...

                    {
                        data ?
                            <>
                                ...
                                <Link href={`/${locale}/cart`}>
                                    <IconButton
                                        ...
                                        className={`${pathname === "/cart" ? "border-primary-500k" : ""}`}
                                    >
                                ...
                                <Dropdown >
                                    ...
                                    >
                                        <li >
                                            <Link href={`${locale}/profile/me`} className='flex flex-row pr-2'>
                                        ...
                                        <span className='divider my-1'></span>
                                        {
                                            (dropDownItems || []).map((menuItem) => {
                                                return <li key={menuItem.id}>
                                                    <Link className='py-4 text-[14px] font-bold' href={menuItem.href}>
                                                        <menuItem.Icon className="w-5 h-5 mx-2 inline" />
                                                        {menuItem.title}
                                                    </Link>
                                                </li>
                                            })
                                        ...
                                        <span className='divider my-1'></span>
                                        <li>
                                            <button type="button" className='w-full py-4 text-[14px] font-bold items-center' onClick={logoutHandler}>
                            ...
                            :
                            <Link href={`/${locale}/auth`} className='btn btn__primary px-8'>
    ...
    return <li >
        <Link className={`block py-4 text-[15px] font-bold transition-all duration-200
         ${activeSegment === menuItem.href ?
            ...
            href={menuItem.href}>
            <menuItem.Icon className="w-5 h-w-5 mx-2 inline" />
            {menuItem.title}
        </Link>
    </li>
}
